            ...
            @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xl text-gray-500  font-semibold">Nombre:</label>
                    ...
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xl text-gray-500  font-semibold">Descripción:</label>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                <label class="uppercase md:text-sm text-xl text-gray-500  font-semibold mb-1">Subir Imagen</label>
                ...
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                    ...
                    <button type="submit" class='w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Añadir uno más a la lista</button>
                </div>
            </form> 
